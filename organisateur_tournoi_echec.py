...
liste_des_joueurs_sans_le_joueur_fictif = []
...
def fonction_bouton_valider_nom_joueur(entry_nom_joueur): 
    ...
    if entry_nom_joueur.get() == "":
        ...
        ajouter_nom_joueur_dans_liste(entry_nom_joueur, liste_des_joueurs_sans_le_joueur_fictif)
    else: 
    ...
    if nombre_question_nom < nombre_de_joueurs_sans_le_joueur_fictif :
        ...
        afficher_nouvelle_page_tableau(liste_des_joueurs_sans_le_joueur_fictif, nombre_de_joueurs)
        


def afficher_nouvelle_page_tableau(liste_des_joueurs_des_joueurs_sans_le_joueur_fictif, nombre_de_joueurs):
    global indice_joueur_liste, dictionnaire_joueurs, round_effectue, liste_des_joueurs
    for widget in window.winfo_children():
        widget.destroy()
    if round_effectue == 0:
...
def afficher_graphique():
    ...
    button_acceder_au_prochain_round = button = Button(window, text="valider", font=("Arial", 20), command=lambda: afficher_nouvelle_page_tableau(liste_des_joueurs_sans_le_joueur_fictif, nombre_de_joueurs))
    button_acceder_au_prochain_round.place(x = 0, y = 0)
